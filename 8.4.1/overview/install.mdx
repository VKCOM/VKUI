...
Шаги те же, что в [базовой установке](#base-install), но отличается CSS-бандл.
...
На примере файла `src/main.tsx` из [базовой установки](#base-install):
...
Чтобы начать с минимальной настройкой, подключите VKUI через [esm.sh](https://esm.sh/) или [esm.run](https://www.jsdelivr.com/esm).
