...
{/* @example-description: Базовая группа `RadioGroup` с несколькими вариантами выбора и неактивной опцией. */}
<Playground>
  ```jsx
  <RadioGroup>
...
| `mode` | `"horizontal" \| "vertical"` | `vertical` | Режим расположения элементов. |
