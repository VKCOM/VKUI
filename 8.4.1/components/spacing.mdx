...
{/* @example-description: Базовый вертикальный отступ `Spacing` между двумя текстовыми блоками. */}
...
| `size` | `SpacingSizeProp` | `m` | Высота спэйсинга.  Принимает значения дизайн-системы, числовые значения и css-переменные. |
