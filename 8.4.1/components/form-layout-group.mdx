...
| `mode` | `"horizontal" \| "vertical"` | `vertical` | Направление отображения элементов формы. |
...
| `removable` | `boolean \| "indent"` | `-` | Только для режима horizontal. Дает возможность удалить всю группу `FormItem`.  Режим `indent` предназначен для визуального отступа. |
...
| `segmented` | `boolean` | `-` | Дает возможность склеить несколько `FormItem`. |
