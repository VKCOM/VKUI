...
{/* @example-description: Градиентная подложка поверх контента для визуального акцента. */}
<Playground>
  ```jsx
  <Gradient
    mode="overlay"
...
| `mode` | `"default" \| "tint" \| "overlay"` | `default` | Тип градиента. |
| `to` | `"top" \| "bottom"` | `top` | Направление градиента. |
