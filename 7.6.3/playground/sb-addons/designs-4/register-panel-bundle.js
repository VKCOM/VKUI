...
`,Vr=M`
  ...
  bottom: 0;
  left: 0;
`,jr=({onZoomIn:o,onZoomOut:e,onReset:t})=>p(_,null,p(le,{onClick:o},p(fo,null)),p(le,{onClick:e},p(mo,null)),p(le,{onClick:t},p(go,null))),zr=(o,e)=>{let[t,r]=T(1);k(()=>{r(o)},e);let i=P(()=>{r(c=>c+.1)},[r]),n=P(()=>{r(c=>Math.max(c-.1,.1))},[r]),s=P(()=>{r(1)},[r]);return{scale:t,zoomIn:i,zoomOut:n,resetZoom:s}},Yr=({config:o})=>{let e=zr(o.scale||1,[o.scale]),t=G(()=>({transform:`scale(${e.scale})`}),[e.scale]);return p("div",{css:Gr},p(dt,{border:!0},p("div",{style:{display:"grid",gridAutoFlow:"column",gap:"4px",alignItems:"center"}},p(_,{key:"left"},p("p",null,p("b",null,"Image")),p(ht,null),p(jr,{onReset:e.resetZoom,onZoomIn:e.zoomIn,onZoomOut:e.zoomOut})))),p(Ur,{css:Wr,defaultValue:o.offset},p("img",{css:Zr,src:o.url,style:t})))},Gr=M`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
