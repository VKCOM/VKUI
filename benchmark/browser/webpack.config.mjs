...
const scenarios = fs.readdirSync(path.resolve(import.meta.dirname, 'scenarios'));
...
const webpackConfig = {
  ...
  mode: 'production',
  target: 'web',
  entry: scenarios.reduce(
    (entries, caseName) => {
      entries[caseName] = {
        import: `./benchmark/browser/scenarios/${caseName}/index.tsx`,
        dependOn: 'vendors',
      };
      return entries;
    },
  ...
  resolve: {
    ...
    alias: { '@vkontakte/vkui$': '@vkontakte/vkui/dist/cssm' },
  },
  plugins: [
