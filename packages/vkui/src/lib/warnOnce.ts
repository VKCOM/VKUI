...
${getA11yRuleUrl('image-alt')}`,
    'aria-allowed-attr': `a11y: Элемент, открывающий плавающий слой, должен быть интерактивным — иначе состояние раскрытия не будет озвучено скринридером. Чтобы исправить эту ошибку, передайте в children кнопку, ссылку или элемент с подходящей ролью.
${getA11yRuleUrl('aria-allowed-attr')}`,
  },
};
