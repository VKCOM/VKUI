    ...
    <>
      ...
      <div className={styles.content}>
        ...
        {hasReactNode(subheader) && (
          <SubheaderTypography Component="p" className={styles.subheader}>
            {subheader}
          </SubheaderTypography>
        )}
        {hasReactNode(text) && (
  ...
  return (
    <RootComponent
      ...
      baseClassName={classNames(
        ...
        mode === 'image' && styles.hostModeImage,
        size === 'm' && styles.hostSizeM,
        mode === 'image' && imageTheme === 'dark' && styles.hostInverted,
      )}
    >
      {asideMode === 'expand' ? (
        <Tappable
