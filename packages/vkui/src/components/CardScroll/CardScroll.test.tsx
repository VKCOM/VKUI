...
const mockHorizontalScrollData = (element: HTMLElement, startScrollLeft = 0) => {
...
const mockCardScrollData = (container: HTMLElement, cardsCount: number, defaultScrollLeft = 50) => {
  ...
  return {
    horizontalScrollData: mockHorizontalScrollData(horizontalScroll, defaultScrollLeft),
    horizontalScroll,
  };
};
...
const prepareDataToTesting = ({ defaultScrollLeft = 50, cardsCount = 6 }: PrepareDataParams) => {
...
describe('CardScroll', () => {
  ...
  it('check scroll by click arrow left', async () => {
    const { horizontalScrollData } = prepareDataToTesting({
