...
describe('HorizontalScroll', () => {
  ...
  it('click on arrow right should change scrollLeft', async () => {
    ...
    const mockedData = mockHorizontalScrollData(ref.current!);
  ...
  it('click on arrow left should change scrollLeft', async () => {
    ...
    const mockedData = mockHorizontalScrollData(ref.current!, 300);
  ...
  it('use custom scroll function to left and right', async () => {
    ...
    const mockedData = mockHorizontalScrollData(ref.current!, 50);
