...
> **Note**
>
> Для корректной анимации переходов, необходимо соблюдать правильный порядок [Panel](#/Panel).
>
> ```jsx static
> <View activePanel="1">
>   <Panel id="1" />
...
> ```
>
> В этом случае будут правильные переходы вперёд/назад между панелями (1 -> 2 -> 3).
