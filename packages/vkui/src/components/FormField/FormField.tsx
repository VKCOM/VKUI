...
export interface FormFieldProps {
  ...
  /**
   * Параметр отвечает за отображение в обычном состоянии
   *
   * - `default` — показываем фон, обводку и текст-подсказку(при наличии)
   * - `plain` — в обычном состоянии показывается только текст-подсказка. В других состояниях поведение не отличается от default
   */
  mode?: 'default' | 'plain';
}
