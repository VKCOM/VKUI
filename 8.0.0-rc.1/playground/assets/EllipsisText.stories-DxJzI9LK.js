import{r as m,f as x,j as u,R as f,m as d}from"./iframe-CDzsgUJ6.js";import{w as C}from"./withCartesian-Dc-q2kCz.js";import{C as y}from"./constants-DdkjnEgz.js";import{c as _}from"./createStoryParameters-CcwS40kl.js";import{g as T}from"./children-__GeZXUq.js";const h="_host_kr76g_1",D="_disableNativeTitle_kr76g_8",g="_content_kr76g_9",v="_contentMultiline_kr76g_23",l={host:h,disableNativeTitle:D,content:g,contentMultiline:v},t=({Component:e="span",className:c,children:r,maxWidth:p,maxLines:n=1,disableNativeTitle:o=!1,...E})=>{const s=m.useRef(null);return x(()=>{s&&s.current&&s.current.style.setProperty("-webkit-line-clamp",n>1?`${n}`:"")},[s,n]),u.jsx(f,{Component:e,className:d(l.host,o&&l.disableNativeTitle,c),title:o?void 0:T(r),...E,children:u.jsx("span",{style:{maxWidth:p},ref:s,className:d(l.content,n>1&&l.contentMultiline),children:r})})};try{t.displayName="EllipsisText",t.__docgenInfo={description:"Компонент ограничивает текстовый контент, убирая его в многоточие.",displayName:"EllipsisText",props:{maxWidth:{defaultValue:null,description:`Пользовательская маскимальная ширина.
