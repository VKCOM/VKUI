...
либо на все страницу в целом.`,name:`direction`,parent:{fileName:`vkui/src/components/ConfigProvider/ConfigProviderContext.tsx`,name:`ConfigProviderContextInterface`},required:!1,tags:{default:"Определяется автоматически в зависимости от значения атрибута `dir` установленного на `body` страницы"},type:{name:`enum`,raw:`Direction`,value:[{value:`"ltr"`},{value:`"rtl"`}]}}},tags:{}}}catch{}}));export{d as n,l as t};