...
Компонент для автоматического рендера иконок в зависимости от [размера интерфейса](/overview/adaptivity#density) – `compact` или `regular`.
...
{/* @example-description: Демонстрация автоматической подстановки размеров иконок для `compact` и `regular` плотности интерфейса. */}
