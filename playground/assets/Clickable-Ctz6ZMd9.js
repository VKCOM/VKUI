import{r as l,t as Y,i as B,n as C,aJ as J,j as m,R as T}from"./iframe-C2_PECK0.js";import{m as R}from"./mergeCalls-Bc-HqyI0.js";import{a as $}from"./type_checkers-CVMjkZjG.js";const f={"-focus-visible":"_-focus-visible_1xi0z_5","-focus-visible--mode-outside":"_-focus-visible--mode-outside_1xi0z_18","-focus-visible--mode-inside":"_-focus-visible--mode-inside_1xi0z_23","-focus-visible--focused":"_-focus-visible--focused_1xi0z_28"};function G(){const[u,e]=l.useState(!1),{keyboardInput:n}=l.useContext(Y),t=l.useCallback(o=>{o.stopPropagation(),e(!0)},[e]),a=l.useCallback(o=>{o.stopPropagation(),e(!1)},[e]);return{focusVisible:n&&u,onFocus:t,onBlur:a}}const O={inside:f["-focus-visible--mode-inside"],outside:f["-focus-visible--mode-outside"]},Q=u=>u==="inside"||u==="outside";function X({focusVisible:u=!1,mode:e="inside"}){const n=Q(e)?O[e]:e;return B(f["-focus-visible"],u&&f["-focus-visible--focused"],u&&n)}function _(u,e=0,n=C){const[t,a]=l.useState(u),s=l.useRef(void 0),o=l.useCallback(i=>{$(i)?a(c=>{const d=i(c);return n(d),d}):(a(i),n(i))},[n]),r=l.useCallback((i,c=e)=>{if(clearTimeout(s.current),c===0){o(i);return}s.current=setTimeout(()=>o(i),c)},[e,o]);return[t,r]}try{_.displayName="useStateWithDelay",_.__docgenInfo={description:`Возвращает значение с состоянием и функции на обновление состояния
без и с задержкой.
...
@example <Tappable>
  ...
  <IconButton unlockParentHover />
  <IconButton />
</Tappable>`,name:"unlockParentHover",required:!1,type:{name:"boolean"}},activeEffectDelay:{defaultValue:null,description:"Длительность показа `active`-состояния.",name:"activeEffectDelay",required:!1,type:{name:"number"}},activeClassName:{defaultValue:null,description:"Стиль подсветки `active`-состояния.",name:"activeClassName",required:!1,type:{name:"string"}},hoverClassName:{defaultValue:null,description:"Стиль подсветки `hover`-состояния.",name:"hoverClassName",required:!1,type:{name:"string"}}}}}catch{}export{x as C,Z as D,X as a,N as c,G as u};
