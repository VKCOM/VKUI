import{M as p,r as n,j as d}from"./iframe-D2wkiYbA.js";import{D as b,C as T}from"./constants-DdkjnEgz.js";import{c as M}from"./createStoryParameters-CcwS40kl.js";const{fn:s}=__STORYBOOK_MODULE_TEST__,D={title:"Utils/Touch",component:p,args:{onClick:s(),onStart:s(),onMove:s(),onEnd:s(),onEndX:s(),onEndY:s()},parameters:M("Touch",{...T,cantered:!1,...b}),tags:["Утилиты"]},k={width:40,height:40,borderRadius:"50%",background:"var(--vkui--color_background_accent)",position:"absolute",left:"50%",top:"50%",marginLeft:-20,marginTop:-20},C={height:200,width:"50%",border:"8px solid var(--vkui--color_icon_secondary)",position:"relative"},o={render:function(R){const[h,g]=n.useState(0),[m,S]=n.useState(0),[c,E]=n.useState(0),[a,L]=n.useState(0),r=n.useRef(null),u=n.useRef(0),f=n.useRef(0);n.useLayoutEffect(()=>{r.current&&(E(r.current.offsetLeft),L(r.current.offsetTop))});const i=(t,e)=>t>e?e:t<-e?-e:t,_=t=>{const e=u.current+t.shiftX,l=f.current+t.shiftY;g(i(e,c)),S(i(l,a))},y=t=>{const e=u.current+t.shiftX,l=f.current+t.shiftY;u.current=i(e,c),f.current=i(l,a)},x=Math.abs(h)>=c||Math.abs(m)>=a;return d.jsx("div",{style:{...C,borderColor:x?"var(--vkui--color_icon_negative)":"var(--vkui--color_icon_secondary)"},children:d.jsx(p,{...R,getRootRef:r,onMove:_,onEnd:y,style:{...k,transform:`translate(${h}px, ${m}px)`}})})}};var Y,X,v;o.parameters={...o.parameters,docs:{...(Y=o.parameters)==null?void 0:Y.docs,source:{originalSource:`{
...
}`,...(v=(X=o.parameters)==null?void 0:X.docs)==null?void 0:v.source}}};const P=["Playground"];export{o as Playground,P as __namedExportsOrder,D as default};
