import{n as d,r as c,h as _,j as g,R as U,aM as w}from"./iframe-DfeTZ_Fw.js";import{u as K}from"./useFocusVisible-BkjzJxRk.js";import{u as Y}from"./useFocusVisibleClassName-BT3I2X7t.js";import{m as P}from"./mergeCalls-Bc-HqyI0.js";import{a as z}from"./type_checkers-CVMjkZjG.js";function y(u,t=0,e=d){const[n,a]=c.useState(u),r=c.useRef(void 0),o=c.useCallback(l=>{z(l)?a(i=>{const C=l(i);return e(C),C}):(a(l),e(l))},[e]),s=c.useCallback((l,i=t)=>{if(clearTimeout(r.current),i===0){o(l);return}r.current=setTimeout(()=>o(l),i)},[t,o]);return[n,s]}try{y.displayName="useStateWithDelay",y.__docgenInfo={description:`Возвращает значение с состоянием и функции на обновление состояния
без и с задержкой.
