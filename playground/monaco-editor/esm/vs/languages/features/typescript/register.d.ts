import { IEvent, IDisposable, Uri } from '../../../editor/editor.api.js';
...
export type { CompilerOptions, Diagnostic, DiagnosticRelatedInformation, DiagnosticsOptions, EmitOutput, IExtraLibs, LanguageServiceDefaults, ModeConfiguration, TypeScriptWorker, WorkerOptions };
