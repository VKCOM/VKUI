...
Смотри https://github.com/VKCOM/VKUI/issues/2123.`,displayName:`DefaultIcon`,props:{}}}catch{}})),u,d,f,p,m,h=e((()=>{u=`_host_sqlyh_1`,d=`_placementRight_sqlyh_13`,f=`_placementBottom_sqlyh_18`,p=`_placementLeft_sqlyh_22`,m={host:u,in:`_in_sqlyh_5`,placementRight:d,placementBottom:f,placementLeft:p}}));function g(e,t={x:0,y:0},n=0,r=!1){let i=e=>{let i={x:t.x||0,y:t.y||0};return e?r?n:i.y+n:r?n:i.x+n};return e.startsWith(`top`)?[`bottom`,{top:`100%`,[_(e,r)]:i(!1)}]:e.startsWith(`right`)?[`left`,{[v(e,r)]:i(!0),left:0}]:e.startsWith(`bottom`)?[void 0,{bottom:`100%`,[_(e,r)]:i(!1)}]:[`right`,{[v(e,r)]:i(!0),right:0}]}function _(e,t){return e.endsWith(`end`)&&t?`right`:`left`}function v(e,t){return e.endsWith(`end`)&&t?`bottom`:`top`}var y,b,x,S=e((()=>{i(),t(),l(),h(),y=a(),b={right:m.placementRight,bottom:m.placementBottom,left:m.placementLeft},x=({offset:e,isStaticOffset:t,coords:i,iconStyle:a,iconClassName:o,placement:s=`bottom`,Icon:l=c,...u})=>{let[d,f]=g(s,i,e,t);return(0,y.jsx)(r,{baseStyle:f,baseClassName:n(m.host,d&&b[d]),...u,children:(0,y.jsx)(l,{className:n(m.in,o),style:a})})};try{x.displayName=`FloatingArrow`,x.__docgenInfo={description:`Иконка-стрелка для всплывающих окон.`,displayName:`FloatingArrow`,props:{offset:{defaultValue:null,description:`Сдвиг стрелки относительно текущих координат.`,name:`offset`,required:!1,type:{name:`number`}},isStaticOffset:{defaultValue:null,description:"Включает абсолютное смещение по `offset`.",name:`isStaticOffset`,required:!1,type:{name:`boolean`}},coords:{defaultValue:null,description:`Координаты стрелки.`,name:`coords`,required:!1,type:{name:`Coords`}},placement:{defaultValue:{value:`bottom`},description:`Расположение всплывающего элемента.`,name:`placement`,required:!1,type:{name:`Placement`}},iconStyle:{defaultValue:null,description:`Стили иконки.`,name:`iconStyle`,required:!1,type:{name:`CSSProperties`}},iconClassName:{defaultValue:null,description:"`className` для иконки.",name:`iconClassName`,required:!1,type:{name:`string`}},Icon:{defaultValue:{value:`(props: React.SVGAttributes<SVGSVGElement>): React.ReactNode => {
  return (
    <svg
