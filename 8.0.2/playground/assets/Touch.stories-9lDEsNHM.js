import{a as e,n as t}from"./chunk-BneVvdWh.js";import{Tt as n,ps as r,wt as i,yo as a}from"./iframe-lhb8_BzR.js";import{i as o,n as s,t as c}from"./constants-CXYaXe_q.js";import{n as l,t as u}from"./createStoryParameters-CbXzS3a6.js";var d,f,p,m,h,g,_,v;t((()=>{d=e(r(),1),o(),l(),n(),f=a(),{fn:p}=__STORYBOOK_MODULE_TEST__,m={title:`Utils/Touch`,component:i,args:{onClick:p(),onStart:p(),onMove:p(),onEnd:p(),onEndX:p(),onEndY:p()},parameters:u(`Touch`,{...c,cantered:!1,...s}),tags:[`Утилиты`]},h={width:40,height:40,borderRadius:`50%`,background:`var(--vkui--color_background_accent)`,position:`absolute`,left:`50%`,top:`50%`,marginLeft:-20,marginTop:-20},g={height:200,width:`50%`,border:`8px solid var(--vkui--color_icon_secondary)`,position:`relative`},_={render:function(e){let[t,n]=d.useState(0),[r,a]=d.useState(0),[o,s]=d.useState(0),[c,l]=d.useState(0),u=d.useRef(null),p=d.useRef(0),m=d.useRef(0);d.useLayoutEffect(()=>{u.current&&(s(u.current.offsetLeft),l(u.current.offsetTop))});let _=(e,t)=>e>t?t:e<-t?-t:e,v=e=>{let t=p.current+e.shiftX,r=m.current+e.shiftY;n(_(t,o)),a(_(r,c))},y=e=>{let t=p.current+e.shiftX,n=m.current+e.shiftY;p.current=_(t,o),m.current=_(n,c)},b=Math.abs(t)>=o||Math.abs(r)>=c;return(0,f.jsx)(`div`,{style:{...g,borderColor:b?`var(--vkui--color_icon_negative)`:`var(--vkui--color_icon_secondary)`},children:(0,f.jsx)(i,{...e,getRootRef:u,onMove:v,onEnd:y,style:{...h,transform:`translate(${t}px, ${r}px)`}})})}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
