import{r as n,v as L,n as l,h as H}from"./iframe-ChnjXsIu.js";import{m as V}from"./mergeCalls-Bc-HqyI0.js";import{a as g}from"./type_checkers-CVMjkZjG.js";function U(){const[u,e]=n.useState(!1),{keyboardInput:t}=n.useContext(L),a=n.useCallback(o=>{o.stopPropagation(),e(!0)},[e]),s=n.useCallback(o=>{o.stopPropagation(),e(!1)},[e]);return{focusVisible:t&&u,onFocus:a,onBlur:s}}function C(u,e=0,t=l){const[a,s]=n.useState(u),d=n.useRef(void 0),o=n.useCallback(r=>{g(r)?s(c=>{const D=r(c);return t(D),D}):(s(r),t(r))},[t]),i=n.useCallback((r,c=e)=>{if(clearTimeout(d.current),c===0){o(r);return}d.current=setTimeout(()=>o(r),c)},[e,o]);return[a,i]}try{C.displayName="useStateWithDelay",C.__docgenInfo={description:`Возвращает значение с состоянием и функции на обновление состояния
без и с задержкой.
