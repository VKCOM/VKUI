import{n as d,r as c,h as _,j as g,R as U,aE as w}from"./iframe-CdtcRMP-.js";import{u as K,a as Y}from"./useFocusVisibleClassName-r8X4bE31.js";import{m as P}from"./mergeCalls-Bc-HqyI0.js";import{a as z}from"./type_checkers-CVMjkZjG.js";function y(u,t=0,e=d){const[n,a]=c.useState(u),s=c.useRef(void 0),o=c.useCallback(l=>{z(l)?a(r=>{const C=l(r);return e(C),C}):(a(l),e(l))},[e]),i=c.useCallback((l,r=t)=>{if(clearTimeout(s.current),r===0){o(l);return}s.current=setTimeout(()=>o(l),r)},[t,o]);return[n,i]}try{y.displayName="useStateWithDelay",y.__docgenInfo={description:`Возвращает значение с состоянием и функции на обновление состояния
без и с задержкой.
