...
Задайте для вашего **root-элемента**, а также для любой дополнительной обёртки над всем приложением, CSS правило
`height: 100%;`, чтобы страница растягивалась на всю высоту вьюпорта.
