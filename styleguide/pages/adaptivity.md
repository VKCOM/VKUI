...
Далее, нужно добавить [`SplitLayout`](#/SplitLayout).
`SplitLayout` — компонент-обертка для отрисовки макета с одной или несколькими колонками. [`SplitCol`](#/SplitCol) — компонент для отрисовки колонки.
```jsx static
// ...
