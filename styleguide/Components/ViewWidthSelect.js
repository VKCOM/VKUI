...
export const ViewWidthSelect = ({ onChange, value, isWide }) => (
  <Fragment>
    Ширина окна:&nbsp;
    <select
      onChange={onChange}
      value={value}
    >
      <option value={MOBILE_SIZE}>{MOBILE_SIZE}px</option>
      <option value={SMALL_TABLET_SIZE}>{SMALL_TABLET_SIZE}px</option>
