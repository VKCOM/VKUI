...
<View activePanel="banner" header={false}>
  <Panel id="banner" separator={false}>
    <PanelHeaderSimple>Banner</PanelHeaderSimple>
    ...
    >
      <Banner
        ...
        actions={<Button mode="overlay">Подробнее</Button>}
      />
    </Group>
