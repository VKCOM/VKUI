...
- Если нужен календарь без поля ввода рекомендуется использовать [CalendarRange](#!/CalendarRange).
- Если нужен выбор одной даты рекомендуется использовать [DateInput](#!/DateInput).
