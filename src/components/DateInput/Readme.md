...
- Если нужен календарь без поля ввода рекомендуется использовать [Calendar](#!/Calendar).
- Если нужен выбор диапазона дат рекомендуется использовать [DateRangeInput](#!/DateRangeInput).
