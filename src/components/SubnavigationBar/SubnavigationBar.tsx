  ...
  return (
    ...
    >
      <ScrollWrapper
        ...
        getScrollToLeft={restProps.getScrollToLeft}
        getScrollToRight={restProps.getScrollToRight}
        showArrows={restProps.showArrows}
        scrollAnimationDuration={restProps.scrollAnimationDuration}
      >
