  ...
  <View activePanel="card">
    <Panel id="card">
      ...
      <Group separator="hide" header={<Header mode="secondary">Дефолтный стиль</Header>}>
        <CardGrid>
          <Card size="l">
            <div style={{ height: 96, background: 'var(--placeholder_icon_background)' }} />
          </Card>
        </CardGrid>
      </Group>
      ...
      <Group header={<Header mode="secondary">Скролл</Header>} separator="hide" description="Рекомендуемый размер карточки — 144px">
        <CardScroll>
          <Card size="s">
            <div style={{ width: 144, height: 96, background: 'var(--placeholder_icon_background)' }} />
          </Card>
          <Card size="s">
            <div style={{ width: 144, height: 96, background: 'var(--placeholder_icon_background)' }} />
          </Card>
      ...
      <Group separator="hide" description="Рекомендуемый размер карточки — 224px">
        <CardScroll>
          <Card size="m">
            <div style={{ width: 224, height: 96, background: 'var(--placeholder_icon_background)' }} />
          </Card>
          <Card size="m">
            <div style={{ width: 224, height: 96, background: 'var(--placeholder_icon_background)' }} />
          </Card>
