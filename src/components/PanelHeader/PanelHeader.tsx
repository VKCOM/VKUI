...
export interface PanelHeaderProps extends HasChildren {
    ...
    return this.state.ready
      ? [
        ReactDOM.createPortal(
          <div
            className={classNames('PanelHeader-bg', {
              [`PanelHeader-bg--${theme}`]: true,
              'PanelHeader-bg--tp': transparent,
              [`PanelHeader-bg--no-shadow`]:
                  noShadow || ['bright_light', 'space_gray'].indexOf(this.context.scheme) >= 0
            })}
          />,
          this.bgNode
        ),
