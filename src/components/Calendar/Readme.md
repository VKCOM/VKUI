...
- Если нужно поле ввода с выпадающим календарем рекомендуется использовать [DateInput](#!/DateInput).
- Если нужен выбор диапазона дат рекомендуется использовать [CalendarRange](#!/CalendarRange).
