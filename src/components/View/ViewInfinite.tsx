...
class _ViewInfinite extends React.Component<ViewInfiniteProps & DOMProps, ViewInfiniteState> {
...
export const ViewInfinite = withContext(withContext(
  withContext(
    withPlatform(withDOM<ViewInfiniteProps>(_ViewInfinite)),
