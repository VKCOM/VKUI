...
До получения данных используйте те же размеры аватара и текстовых слотов, что и в итоговой ячейке.

{/* @example-description: Заглушка `Cell` с аватаром и двумя строками текста. */}
