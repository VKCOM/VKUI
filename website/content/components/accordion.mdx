...
<Accordion>
  ...
  <Accordion.Content>
    <Div>
      ...
      получится. В центре внимания нового дизайна — личность человека и его увлечения. Новый формат
      профиля особенно удобен для авторов контента и станет для них цифровой визиткой.
    </Div>
  </Accordion.Content>
</Accordion>
```
...
Используйте свойства `expanded` и `onChange` для ручного управления состоянием компонента.
