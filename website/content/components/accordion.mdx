...
{/* @example-description: Базовый пример использования Accordion с заголовком и текстовым контентом. */}
...
{/* @example-description: Группа аккордеонов с контролируемым состоянием — только один элемент может быть раскрыт одновременно. */}
...
{/* @example-description: Кастомные иконки раскрытия/сворачивания с позиционированием перед текстом. */}
<Playground Wrapper={BlockWrapper} style={{ height: 180 }}>
  ```jsx
  <Accordion>
    <Accordion.Summary
