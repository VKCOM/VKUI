...
Чтобы расположить иконку в любом месте, используйте компонент `<Accordion.Indicator />`
...
return(
  <Accordion>
    <Accordion.Summary
      ...
      badgeAfterTitle={<Accordion.Indicator />}
    >
      Разработчики
    </Accordion.Summary>
    <Accordion.Content>
...
### Accordion.Indicator [#accordion-icon-api]
