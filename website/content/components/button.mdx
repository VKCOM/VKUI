...
`loadingAriaLabel` (по умолчанию "Загрузка..."), чтобы скринридер мог объявить контекст загрузки. Вы можете переопределить это
значение, передав свойство `loadingAriaLabel`.

<Playground>
  ```jsx
  <Button loading>Button</Button>
  <Button loading loadingAriaLabel="Сохранение данных...">Button</Button>
  ```
</Playground>
