...
{/* @example-description: Базовый пример кнопки с текстовой подписью. */}
<Playground>
  ```jsx
...
{/* @example-description: Все режимы `mode` для кнопки с цветовой схемой `appearance="accent"`. */}
<Playground>
  ```jsx
...
{/* @example-description: Варианты `mode` с неизменяемым акцентным цветом `accent-invariable`. */}
<Playground>
  ```jsx
...
{/* @example-description: Примеры позитивного стиля `appearance="positive"` для разных режимов кнопки. */}
<Playground>
  ```jsx
