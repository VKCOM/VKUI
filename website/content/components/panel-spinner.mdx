...
Компонент-обёртка для индикатора загрузки, оптимизированный для использования внутри панелей ([`Panel`](/components/panel)).
Автоматически добавляет стандартные отступы и центрирование.
