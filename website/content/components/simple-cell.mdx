...
Чтобы длинный текст отображался в несколько строк, используйте свойство `multiline`.
...
Сохраняйте структуру ячейки во время загрузки: отдельно обозначайте аватар, заголовок и подзаголовок.

{/* @example-description: Заглушка `SimpleCell` с аватаром и двумя строками текста. */}
<Playground contrastBackground Wrapper={BlockWrapper} style={{ maxWidth: 320 }}>
  ```jsx
  <SimpleCell
