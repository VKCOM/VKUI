...
#### PanelHeaderBack [#panel-header-back] [tag:component]
...
#### PanelHeaderClose [#panel-header-close] [tag:component]
...
#### PanelHeaderEdit [#panel-header-edit] [tag:component]
...
#### PanelHeaderSubmit [#panel-header-submit] [tag:component]
