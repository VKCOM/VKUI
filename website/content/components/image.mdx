...
> Свойство `visibility` подкомпонента `Avatar.Overlay` по умолчанию зависит от наличия указателя на устройстве. На мобильных наложение показано всегда, на десктопах — только при наведении на аватар.
...
Размер и радиус заглушки должны совпадать с ожидаемым изображением.

{/* @example-description: Заглушка для квадратного изображения размером 96px. */}
