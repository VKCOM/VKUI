...
{/* @example-description: Базовый аватар пользователя с фотографией и альтернативным текстом. */}
<Playground>
  ```jsx
...
{/* @example-description: Отображение инициалов в аватаре, когда фотография отсутствует. */}
<Playground>
  ```jsx
  <Avatar initials="ВК" />
  ```
...
{/* @example-description: Аватар с инициалами на одном из предустановленных градиентных фонов. */}
<Playground>
  ```jsx
...
{/* @example-description: Сетка аватаров с разными значениями `size` для подбора подходящего масштаба. */}
<Playground>
  ```jsx
