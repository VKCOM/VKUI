...
Для карточки лучше обозначить медиаблок и текст отдельно, сохранив итоговый размер контента.

{/* @example-description: Составная заглушка карточки с изображением и текстом. */}
