...
|---|---|
| [DisplayTitle](/components/display-title) | Крупные заголовки (уровни 1–4) |
| [Title](/components/title) | Заголовки (уровни 1–3) |
| [Headline](/components/headline) | Подзаголовки (уровни 1–2) |
| [Text](/components/text-typography) | Основной наборный текст |
| [Paragraph](/components/paragraph) | Основной текст с параграфными отступами |
| [Subhead](/components/subhead) | Подзаголовки второго уровня |
| [Footnote](/components/footnote) | Основные подписи |
| [Caption](/components/caption) | Мелкие подписи (уровни 1–3) |

## Базовые свойства [#base-props]
...
{/* @example-description: Пример типографики `Text` с насыщенностью `weight="1"`. */}
<Playground>
  ```jsx
...
{/* @example-description: Пример `Text` с акцентной насыщенностью через `useAccentWeight`. */}
<Playground>
  ```jsx
...
{/* @example-description: Использование `normalize` для сброса стандартных отступов у блочного текста. */}
<Playground>
  ```jsx
...
{/* @example-description: Переопределение HTML-тега типографического компонента через `Component`. */}
<Playground>
  ```jsx
  <Paragraph Component="p" normalize>
    Текст в теге &lt;p&gt;
...
{/* @example-description: Строчное отображение разных типографических компонентов с `inline`. */}
<Playground>
  ```jsx
...
{/* @example-description: Выравнивание текста в блоке через свойство `align`. */}
