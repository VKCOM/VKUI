...
Небольшое всплывающее окно-подсказка, открывающееся при наведении мыши на `children` (или при долгом нажатии на мобильных устройствах).
