...
Используйте `Skeleton` как содержимое `SelectMimicry`: компонент сам сохранит внешний вид и адаптивную высоту поля.

{/* @example-description: Адаптивный `SelectMimicry` с заглушкой вместо значения. */}
<Playground contrastBackground style={{ width: 270 }}>
  ```jsx
