...
- `offsetYStart: VerticalOffset` - Вертикальный отступ контейнера со снекбарами от верха. Полезно, когда нужно немного сдвинуть верхнюю границу снекбаров.
- `offsetYEnd: VerticalOffset` - Вертикальный отступ контейнера со снекбарами от низа. Полезно, когда нужно немного сдвинуть нижнюю границу снекбаров.
...
- `setOffsetYStart(offset: SnackbarApi.VerticalOffset): void` - Метод для изменения отступа контейнера снекбаров от верха.
- `setOffsetYEnd(offset: SnackbarApi.VerticalOffset): void` - Метод для изменения отступа контейнера снекбаров снизу.
