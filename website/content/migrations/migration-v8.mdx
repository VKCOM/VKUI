...
- Если вам нужно, чтобы какой-то из элементов растягивался на высоту области видимости,
...
Обновлены цвета для нейтрального режима (`appearance="neutral"`):
...
Значение `null` означает, что дата сброшена (поле очищено). Значение `undefined` убрано из типа,
