...
Компонент для автоматического выбора иконок в зависимости от размера интерфейса. Позволяет легко переключаться между regular/compact-режимами без ручной проверки условий.
