...
Если вы разработчик мини-приложений ВКонтакте, то рекомендуем также ознакомиться со страницей
[Интеграции | VK Mini Apps](/integrations/vk-mini-apps).
...
Рекомендуем это делать в корне приложения.
...
- [`AppRoot`](/components/app-root) – управляет режимами встраивания, скроллом, безопасными отступами и порталами.
