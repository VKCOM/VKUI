...
[`Epic`](/components/epic) — для мобильных приложений, где по дизайну нужна классическая нижняя панель с основными разделами. Пример — [m.vk.ru](https://m.vk.ru) или нативное приложение VK.
