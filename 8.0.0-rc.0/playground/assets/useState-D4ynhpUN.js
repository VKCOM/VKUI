import{r as n,y as I,n as i,g as H}from"./iframe-D-vjmezP.js";import{m as V}from"./mergeCalls-Bc-HqyI0.js";import{a as g}from"./type_checkers-CVMjkZjG.js";function U(){const[u,e]=n.useState(!1),{keyboardInput:t}=n.useContext(I),r=n.useCallback(o=>{o.stopPropagation(),e(!0)},[e]),a=n.useCallback(o=>{o.stopPropagation(),e(!1)},[e]);return{focusVisible:t&&u,onFocus:r,onBlur:a}}function C(u,e=0,t=i){const[r,a]=n.useState(u),d=n.useRef(void 0),o=n.useCallback(s=>{g(s)?a(l=>{const D=s(l);return t(D),D}):(a(s),t(s))},[t]),c=n.useCallback((s,l=e)=>{if(clearTimeout(d.current),l===0){o(s);return}d.current=setTimeout(()=>o(s),l)},[e,o]);return[r,c]}try{C.displayName="useStateWithDelay",C.__docgenInfo={description:`Возвращает значение с состоянием и функции на обновление состояния
без и с задержкой.
